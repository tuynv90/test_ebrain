...
@Injectable()
export class mn_learningEndpoint extends EndpointFactory {

    private readonly _serviceUrl: string = "/api/mn-learning";
    ...
    getDataEndpoint(filter: string, value: string): Observable<Response> {
        ...
        return this.http.get(url, this.getAuthHeader())
            ...
            .catch(error => {
                return this.handleError(error, () => this.getDataEndpoint(filter, value));
            });
    }
