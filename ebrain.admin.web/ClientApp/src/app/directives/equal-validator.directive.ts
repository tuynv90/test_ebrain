...
export function IsPresentString(value: string) {
    return value !== null && value !== undefined && value.length > 0;
}

export function IsPresentGuid(value: string) {
    return value !== null && value !== undefined && value.length > 0
        && value !== '00000000-0000-0000-0000-000000000000';
}

export function EmptyReplace(value: string): string {
    if (!IsPresentString(value) || value === "Tất cả") {
        value = '';
    }
    return value;
}