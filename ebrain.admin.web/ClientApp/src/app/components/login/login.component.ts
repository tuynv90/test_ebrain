...
export class LoginComponent implements OnInit, OnDestroy {
    ...
    constructor(
      // private storageManager: LocalStoreManager, private alertService: AlertService, private authService: AuthService, private configurations: ConfigurationService,
