...
using Superbrain.Authorization;
using Superbrain.Helpers;
using Superbrain.ViewModels;
...
namespace Superbrain
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("Superbrain"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Superbrain API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Superbrain API V1");
            });
