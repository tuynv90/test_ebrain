...
namespace Superbrain.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        {
            var allCustomers = _unitOfWork.Customers.Search("", "");
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailer.SendEmailAsync(recepientName, recepientEmail, "Test Email from Superbrain", message);
